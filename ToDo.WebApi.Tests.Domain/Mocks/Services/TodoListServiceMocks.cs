...
namespace ToDo.WebApi.Tests.Unit.Setups.Services
{
    public static class TodoListServiceMocks
    {
        ...
        #region Get
        public static Mock<ITodoListService> SetupGetValidIdReturnsTodoList(this Mock<ITodoListService> mock, int Id, TodoList list)
        {
            mock.Setup(service =>
                    service.Get(Id))
                    .Returns(list);
        ...
        public static Mock<ITodoListService> SetupGetInvalidIdReturnsNull(this Mock<ITodoListService> mock, int Id)
        {
            mock.Setup(service =>
                    service.Get(Id))
        ...
        public static Mock<ITodoListService> SetupDeleteReturnsDeletionFailedError(this Mock<ITodoListService> mock, TodoList list)
        {
            mock.Setup(service =>
