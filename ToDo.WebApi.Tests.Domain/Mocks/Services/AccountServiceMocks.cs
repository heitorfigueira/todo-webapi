...
namespace ToDo.WebApi.Tests.Unit.Setups.Services
{
    public static class AccountServiceMocks
    {
        ...
        #region Get
        public static Mock<IAccountService> SetupGetValidIdReturnsAccount(this Mock<IAccountService> mock, Guid Id, Account account)
        {
            mock.Setup(service =>
                    service.Get(Id))
                    .Returns(account);
        ...
        public static Mock<IAccountService> SetupGetInvalidIdReturnsNull(this Mock<IAccountService> mock, Guid Id)
        {
            mock.Setup(service =>
                    service.Get(Id))
        ...
        #region Delete
        public static Mock<IAccountService> SetupDeleteReturnsCreationFailedError(this Mock<IAccountService> mock)
        {
            mock.Setup(service =>
        ...
        public static Mock<IAccountService> SetupDeleteReturnsDeletionFailedError(this Mock<IAccountService> mock, Account account)
        {
            mock.Setup(service =>
